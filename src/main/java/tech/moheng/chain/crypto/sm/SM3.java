package tech.moheng.chain.crypto.sm;
...
public class SM3 {
	...
	public static String hash(String hexInput) throws IOException {
	...
	public static void main(String[] args) throws IOException {
		System.out.println(SM3.byteArrayToHexString(SM3.hash("moac".getBytes())));
		String aa = "moac";
		System.out.println(SM3.hash(aa.getBytes()));
	}
}